...
**Started:** 2026-06-30
**Phase:** 3 — Декомпозиция бэка (task 4 done, task 5 pending) — 2026-07-04

Tasks 1-4 закрыты. Task 4 (activation_manager split): activation_manager 626→150, encounters.py (191) + materialization.py (344) вынесены, activation-логика не тронута. make check зелёный. Скоуп task 6 (реестр экипировки) — на подтверждении координатора (decision_gate), дефолт вариант A.
