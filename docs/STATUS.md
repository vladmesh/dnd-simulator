...
**Started:** 2026-07-10
**Phase:** 3 — Travel as an intent (task 2 done, task 3 pending) — 2026-07-11

`TRAVEL` запускает сохраняемый маршрут без телепортации; activation передвигает существо по одному ребру на временной границе, а fast-forward останавливается на каждом прибытии. Ready to start task 3.
