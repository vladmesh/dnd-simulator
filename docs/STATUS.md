...
**Started:** 2026-07-10
**Phase:** 3 — Travel as an intent (task 1 done, task 2 pending) — 2026-07-11

Travel intent и его строгая save-модель сохраняют оставшийся маршрут и следующую границу прибытия. `LocationGraph` детерминированно выбирает кратчайший по суммарной длине путь. Ready to start task 2.
