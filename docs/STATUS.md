...
**Started:** 2026-07-10
**Phase:** 3 — Travel as an intent (all tasks done, ready to close) — 2026-07-11

Общий REST/WS player status отдаёт типизированный journey view с именами точек и оставшимся маршрутом; location UI отправляет `TRAVEL`, показывает прогресс и очищает его после прибытия. Фаза готова к закрытию.
