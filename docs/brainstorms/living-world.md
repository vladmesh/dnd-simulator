...
> **Актуализация 2026-07-04:** направление развито в [simulation-core.md](simulation-core.md) — лестница детализации (число → эфемер → зародыш → именной → активный), событийная запись вверх, храповик субъектности. Сквадная материализация отсюда — прототип лестницы.
