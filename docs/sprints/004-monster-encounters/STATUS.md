...
**Phase:** 4 — Frontend + E2E (COMPLETE)
**Updated:** 2026-03-25

## Current

All phases complete. Audit and triage done.
...
- Phase 4 (Frontend + E2E) ✓ — Squad events in perception pipeline, frontend rendering, manual E2E playtest with 18 bug fixes (combat auto-start, faction-aware targeting, ability mod to damage, session autosave/evict, param validation crashes)

## Audit Triage

Triaged on 2026-03-26. Quick-fix: 1 applied (dead code removal). Sprint-relevant: 0 (false positives on inspection, rest → backlog). Backlog: 34 items added/updated in BACKLOG.md.
