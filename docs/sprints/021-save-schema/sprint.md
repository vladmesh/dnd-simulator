...
- Post-audit E2E: «блокер» отчёта переквалифицирован — одинаковые accessible names у Attack-кнопок ломают адресацию целей в автоматизации (продукт цел, все сценарии прошли или верифицированы на фикстуре); заведено `attack-buttons-accessible-names` + `saves-dir-env` + `spawn-api-xp-value` (2026-07-10).
