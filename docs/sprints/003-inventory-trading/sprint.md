...
**Верификация:** `make check` зелёный, `rg 'from dnd_simulator.layers' src/dnd_simulator/rules/` = 0 hits, role string literals replaced by enum.

**Tasks:**

1. [NpcRole Enum + Fix rules→layers Dependency](tasks/phase4-task1-npc-role-enum.md)
2. [Extract NPC Content Tables to YAML](tasks/phase4-task2-extract-npc-content.md)

---

## Status

**Current:** Phase 4 created for audit refactor. Tasks pending.
